...
//    @Excel(name = "单注投注金额")
    ...
    @Excel(name = "虚拟注单", readConverterExp = "1=是,0=否")
    @ApiModelProperty(value = "虚拟注单，1-是，0-否")
    private Byte isAuto;

    @Excel(name = "测试注单", readConverterExp = "1=是,0=否")
    @ApiModelProperty(value = "测试注单，1-是，0-否")
    private Byte isTest;
